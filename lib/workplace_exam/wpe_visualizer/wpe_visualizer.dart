...
import 'package:xapptor_business/workplace_exam/wpe_visualizer/name_and_skills.dart';
import 'package:xapptor_business/workplace_exam/wpe_visualizer/populate_sections.dart';
import 'package:xapptor_business/workplace_exam/wpe_visualizer/populate_skills.dart';
...
class _ResumeVisualizerState extends State<ResumeVisualizer> {
  ...
  fetch_resume() async {
    ...
    DocumentSnapshot resume_doc =
        await XapptorDB.instance.collection("resumes").doc(resume_id).get();
