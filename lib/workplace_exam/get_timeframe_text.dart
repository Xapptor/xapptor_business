...
get_timeframe_text({
  ...
  String timeframe_text_1 =
      begin_text.substring(0, 1).toUpperCase() + begin_text.substring(1);
  String timeframe_text_2 =
      end_text.substring(0, 1).toUpperCase() + end_text.substring(1);

  timeframe_text = "$timeframe_text_1 - $timeframe_text_2";

  if (show_time_amount) {
    int months_difference =
        (begin.month - end.month + 12 * (begin.year - end.year)).abs();
