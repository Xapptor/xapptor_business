...
class WpeRiskIdentifiedSegment extends StatefulWidget {
  ...
  const WpeRiskIdentifiedSegment({
    super.key,
  ...
  @override
  State<WpeRiskIdentifiedSegment> createState() => _WpeRiskIdentifiedSegmentState();
}
        ...
        DropdownButton<String>(
          ...
          onChanged: (String? new_value) {
            setState(() {
              ...
              widget.any_risk_identified.value = new_value.toLowerCase() == 'yes';
            });
          },
          items: risk_identified_list.map<DropdownMenuItem<String>>((String value) {
